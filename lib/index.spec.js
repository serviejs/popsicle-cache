...
test('popsicle cache', function (t) {
  ...
  t.test('uncacheable', function (t) {
    ...
    t.test('make fresh http call', function (t) {
      return popsicle.get('http://example.com/no')
        .then(function (res) {
  ...
  t.test('expires header', function (t) {
    ...
    t.test('make fresh http call', function (t) {
      return popsicle.get('http://example.com/expires')
        .use(cache())
        .then(function (res) {
  ...
  t.test('cache control header', function (t) {
    ...
    t.test('make fresh http call', function (t) {
      return popsicle.get('http://example.com/cache-control')
        .use(cache())
        .then(function (res) {
          t.deepEqual(res.body, { success: true })
        })
  ...
  t.test('last modified', function (t) {
    ...
    t.test('make fresh http call', function (t) {
      return popsicle.get('http://example.com/modified')
        .use(cache())
        .then(function (res) {
          t.deepEqual(res.body, { success: true })
        })
  ...
  t.test('etag', function (t) {
    ...
    t.test('make fresh http call', function (t) {
      return popsicle.get('http://example.com/etag')
        .use(cache())
        .then(function (res) {
          t.deepEqual(res.body, { success: true })
        })
  ...
  t.test('unavailable', function (t) {
    ...
    t.test('make fresh http call', function (t) {
      return popsicle.get('http://example.com/unavailable')
        .use(cache())
        .then(function (res) {
          t.deepEqual(res.body, { success: true })
        })
  ...
  t.test('file race condition', function (t) {
    ...
    t.test('multiple read file', function (t) {
      ...
      return Promise.all([
        popsicle.get('http://example.com').use(cached),
        popsicle.get('http://example.com').use(cached),
        popsicle.get('http://example.com').use(cached)
      ])
        .then(function () {
          return popsicle.get('http://example.com').use(cached)
        })
    })
  })
